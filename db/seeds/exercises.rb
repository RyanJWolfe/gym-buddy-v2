...
EXERCISES = [
  ...
  { name: "Dumbbell Pullover", categories: [ CHEST, LATS ], equipment_type: :dumbbell, description: "An exercise that works the chest and lats." },
  ...
  { name: "Band Pull-Apart", categories: [ REAR_DELTS, UPPER_BACK ], equipment_type: :resistance_band, description: "An exercise that targets the rear deltoids and upper back." },
  ...
  { name: "Barbell Rear Delt Row", categories: [ SHOULDERS, UPPER_BACK ], equipment_type: :barbell, description: "A compound exercise that works the rear deltoids and upper back." },
  { name: "Barbell Upright Row", categories: [ SHOULDERS, TRAPS ], equipment_type: :barbell, description: "A compound exercise that works the shoulders and traps." },
  ...
  { name: "Cable Rear Delt Row", categories: [ SHOULDERS, UPPER_BACK ], equipment_type: :cable, description: "A compound exercise that works the rear deltoids and upper back." },
  ...
  { name: "Dumbbell Rear Delt Row", categories: [ SHOULDERS, UPPER_BACK ], equipment_type: :dumbbell, description: "A compound exercise that works the rear deltoids and upper back." },
  ...
  { name: "Face Pull", categories: [ REAR_DELTS, UPPER_BACK ], equipment_type: :cable, description: "An exercise that targets the rear deltoids and upper back." },
  ...
  { name: "Monkey Row", categories: [ SHOULDERS, UPPER_BACK ], equipment_type: :bodyweight, description: "A compound exercise that works the shoulders and back." },
  ...
  { name: "Power Jerk", categories: [ SHOULDERS, QUADRICEPS ], equipment_type: :barbell, description: "A dynamic overhead pressing movement." },
  { name: "Push Press", categories: [ SHOULDERS, QUADRICEPS ], equipment_type: :barbell, description: "A dynamic overhead pressing movement." },
  { name: "Reverse Cable Flyes", categories: [ REAR_DELTS, UPPER_BACK ], equipment_type: :cable, description: "An isolation exercise that targets the rear deltoids." },
  { name: "Reverse Dumbbell Flyes", categories: [ REAR_DELTS, UPPER_BACK ], equipment_type: :dumbbell, description: "An isolation exercise that targets the rear deltoids." },
  { name: "Reverse Machine Fly", categories: [ REAR_DELTS, UPPER_BACK ], equipment_type: :machine, description: "An isolation exercise that targets the rear deltoids." },
  ...
  { name: "Squat Jerk", categories: [ SHOULDERS, QUADRICEPS ], equipment_type: :barbell, description: "A dynamic overhead pressing movement." },
  { name: "Split Jerk", categories: [ SHOULDERS, QUADRICEPS ], equipment_type: :barbell, description: "A dynamic overhead pressing movement." },
  ...
  # Legs
  { name: "Barbell Front Squat", categories: [ QUADRICEPS, ABDOMINALS ], equipment_type: :barbell, description: "A compound exercise that targets the quadriceps and core." },
  { name: "Barbell Hack Squat", categories: [ QUADRICEPS ], equipment_type: :barbell, description: "A compound exercise that targets the quadriceps." },
  { name: "Barbell Lunge", categories: [ QUADRICEPS, GLUTES ], equipment_type: :barbell, description: "A compound exercise that targets the quadriceps and glutes." },
  { name: "Barbell Squat", categories: [ QUADRICEPS, HAMSTRINGS, GLUTES ], equipment_type: :barbell, description: "A compound exercise that targets the quadriceps, hamstrings, and glutes." },
  { name: "Bodyweight Squat", categories: [ QUADRICEPS, GLUTES ], equipment_type: :bodyweight, description: "A compound exercise that targets the lower body." },
  { name: "Bulgarian Split Squat", categories: [ QUADRICEPS, GLUTES ], equipment_type: :dumbbell, description: "A compound exercise that targets the quadriceps and glutes." },
  { name: "Dumbbell Lunge", categories: [ QUADRICEPS, GLUTES ], equipment_type: :dumbbell, description: "A compound exercise that targets the quadriceps and glutes." },
  { name: "Dumbbell Squat", categories: [ QUADRICEPS, GLUTES ], equipment_type: :dumbbell, description: "A compound exercise that targets the lower body." },
  { name: "Hip Thrust", categories: [ GLUTES, HAMSTRINGS ], equipment_type: :barbell, description: "A compound exercise that targets the glutes and hamstrings." },
  { name: "Leg Extension", categories: [ QUADRICEPS ], equipment_type: :machine, description: "An isolation exercise that targets the quadriceps." },
  { name: "Leg Press", categories: [ QUADRICEPS, GLUTES ], equipment_type: :machine, description: "A compound exercise that targets the lower body." },

  # Back
  { name: "Barbell Bent Over Row", categories: [ UPPER_BACK, LATS ], equipment_type: :barbell, description: "A compound exercise that targets the upper back and lats." },
  { name: "Barbell Deadlift", categories: [ LOWER_BACK, HAMSTRINGS, GLUTES ], equipment_type: :barbell, description: "A compound exercise that targets the entire back and posterior chain." },
  { name: "Barbell Good Morning", categories: [ LOWER_BACK, HAMSTRINGS ], equipment_type: :barbell, description: "A compound exercise that targets the lower back and hamstrings." },
  { name: "Barbell Row", categories: [ UPPER_BACK, LATS ], equipment_type: :barbell, description: "A compound exercise that targets the upper back and lats." },
  { name: "Cable Face Pull", categories: [ REAR_DELTS, UPPER_BACK ], equipment_type: :cable, description: "An isolation exercise that targets the rear deltoids and upper back." },
  { name: "Cable Lat Pulldown", categories: [ LATS ], equipment_type: :cable, description: "A compound exercise that targets the lats." },
  { name: "Cable Row", categories: [ UPPER_BACK, LATS ], equipment_type: :cable, description: "A compound exercise that targets the upper back and lats." },
  { name: "Chin-Up", categories: [ LATS, BICEPS ], equipment_type: :bodyweight, description: "A compound exercise that targets the lats and biceps." },
  { name: "Dumbbell Bent Over Row", categories: [ UPPER_BACK, LATS ], equipment_type: :dumbbell, description: "A compound exercise that targets the upper back and lats." },
  { name: "Dumbbell Row", categories: [ UPPER_BACK, LATS ], equipment_type: :dumbbell, description: "A compound exercise that targets the upper back and lats." },
  { name: "Inverted Row", categories: [ UPPER_BACK, BICEPS ], equipment_type: :bodyweight, description: "A compound exercise that targets the upper back and lats." },
  { name: "Lat Pulldown", categories: [ LATS ], equipment_type: :machine, description: "A compound exercise that targets the lats." },
  { name: "Pull-Up", categories: [ LATS, BICEPS ], equipment_type: :bodyweight, description: "A compound exercise that targets the lats and upper back." },
  { name: "Seated Cable Row", categories: [ UPPER_BACK, LATS ], equipment_type: :cable, description: "A compound exercise that targets the upper back and lats." },
  { name: "T-Bar Row", categories: [ UPPER_BACK, LATS ], equipment_type: :barbell, description: "A compound exercise that targets the upper back and lats." },

  # Glute
  { name: "Barbell Hip Thrust", categories: [ GLUTES, HAMSTRINGS ], equipment_type: :barbell, description: "A compound exercise that targets the glutes and hamstrings." },
  { name: "Barbell Romanian Deadlift", categories: [ GLUTES, HAMSTRINGS, LOWER_BACK ], equipment_type: :barbell, description: "A compound exercise that targets the glutes and hamstrings." },
  { name: "Cable Pull Through", categories: [ GLUTES, HAMSTRINGS ], equipment_type: :cable, description: "A compound exercise that targets the glutes and hamstrings." },
  { name: "Dumbbell Romanian Deadlift", categories: [ GLUTES, HAMSTRINGS, LOWER_BACK ], equipment_type: :dumbbell, description: "A compound exercise that targets the glutes and hamstrings." },
  { name: "Glute Bridge", categories: [ GLUTES ], equipment_type: :bodyweight, description: "An isolation exercise that targets the glutes." },
  { name: "Hip Abduction", categories: [ ABDUCTORS ], equipment_type: :machine, description: "An isolation exercise that targets the gluteus medius." },
  { name: "Hip Extension", categories: [ GLUTES ], equipment_type: :machine, description: "An isolation exercise that targets the glutes." },
  { name: "Kettlebell Swing", categories: [ GLUTES, HAMSTRINGS, OTHER ], equipment_type: :kettlebell, description: "A compound exercise that targets the glutes and hamstrings." },
  { name: "Lateral Band Walk", categories: [ GLUTES, ABDUCTORS ], equipment_type: :resistance_band, description: "An isolation exercise that targets the gluteus medius." },
  { name: "Romanian Deadlift", categories: [ GLUTES, HAMSTRINGS, LOWER_BACK ], equipment_type: :barbell, description: "A compound exercise that targets the glutes and hamstrings." },
  ...
  { name: "Step-Up", categories: [ GLUTES, QUADRICEPS ], equipment_type: :dumbbell, description: "A compound exercise that targets the glutes and quadriceps." },
  ...
  # Calves
  { name: "Calf Raise", categories: [ CALVES ], equipment_type: :machine, description: "An isolation exercise that targets the calves." },
  { name: "Donkey Calf Raise", categories: [ CALVES ], equipment_type: :machine, description: "An isolation exercise that targets the calves." },
  { name: "Seated Calf Raise", categories: [ CALVES ], equipment_type: :machine, description: "An isolation exercise that targets the calves." },
  { name: "Standing Calf Raise", categories: [ CALVES ], equipment_type: :machine, description: "An isolation exercise that targets the calves." },

  # Forearm Flexors
  { name: "Barbell Wrist Curl", categories: [ FOREARMS ], equipment_type: :barbell, description: "An isolation exercise that targets the forearm flexors." },
  { name: "Dumbbell Wrist Curl", categories: [ FOREARMS ], equipment_type: :dumbbell, description: "An isolation exercise that targets the forearm flexors." },
  { name: "Farmer's Walk", categories: [ FOREARMS, UPPER_BACK, ABDOMINALS ], equipment_type: :dumbbell, description: "A compound exercise that targets the forearm flexors and grip strength." },
  { name: "Plate Pinch", categories: [ FOREARMS ], equipment_type: :plate, description: "An isolation exercise that targets the forearm flexors and grip strength." },
  { name: "Towel Pull-Up", categories: [ FOREARMS, UPPER_BACK, BICEPS ], equipment_type: :bodyweight, description: "A compound exercise that targets the forearm flexors and grip strength." },
  ...
  # Cardio / Other
  { name: "Burpee", categories: [ OTHER, QUADRICEPS, CHEST, SHOULDERS ], equipment_type: :bodyweight, description: "A compound exercise that targets the entire body and cardiovascular system." },
  { name: "High-Intensity Interval Training (HIIT)", categories: [ CARDIO ], equipment_type: :bodyweight, description: "A form of cardiovascular exercise that alternates between high-intensity and low-intensity periods." },
  { name: "Jump Rope", categories: [ CARDIO, CALVES ], equipment_type: :other, description: "A compound exercise that targets the cardiovascular system and coordination." },
  { name: "Mountain Climber", categories: [ CARDIO, ABDOMINALS ], equipment_type: :bodyweight, description: "A compound exercise that targets the core and cardiovascular system." },
  { name: "Running", categories: [ CARDIO, QUADRICEPS ], equipment_type: :bodyweight, description: "A compound exercise that targets the cardiovascular system and lower body." },
  { name: "Sprint", categories: [ CARDIO, QUADRICEPS ], equipment_type: :bodyweight, description: "A high-intensity compound exercise that targets the cardiovascular system and lower body." },
  { name: "Swimming", categories: [ CARDIO, LATS, SHOULDERS, CHEST ], equipment_type: :bodyweight, description: "A compound exercise that targets the entire body and cardiovascular system." },
  { name: "Tabata", categories: [ CARDIO ], equipment_type: :bodyweight, description: "A form of high-intensity interval training that alternates between 20 seconds of work and 10 seconds of rest." }
].freeze
